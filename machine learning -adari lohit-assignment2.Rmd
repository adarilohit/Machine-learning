...
```{r}
getwd()
data <- data.frame(read.csv("UniversalBank.csv"))
str(data)
...
test.na <- is.na.data.frame("data")

##Converting data types of attributes
data$Education <- as.character(data$Education)
is.character(data$Education)
...
##Dummying Variables
DummyVariables <- dummyVars(~Education, data)
head(predict(DummyVariables, data))
data2 <- predict(DummyVariables,data)
